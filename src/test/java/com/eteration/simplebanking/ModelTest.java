...
public class ModelTest {
    ...
    public void testTransactions() throws InsufficientBalanceException {
        ...
        depositTrx.setDate(LocalDateTime.now());
        depositTrx.setType(depositTrx.getClass().getSimpleName());
        ...
        withdrawalTrx.setDate(LocalDateTime.now());
        withdrawalTrx.setType(withdrawalTrx.getClass().getSimpleName());
